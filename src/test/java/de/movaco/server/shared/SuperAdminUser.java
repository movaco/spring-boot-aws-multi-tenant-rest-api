...
import de.movaco.server.shared.SuperAdminUser.AdminMockSecurityContextFactory;
...
public @interface SuperAdminUser {

  String username() default "superAdmin";

  String[] roles() default {Roles.SUPER_ADMIN};
  ...
  class AdminMockSecurityContextFactory implements WithSecurityContextFactory<SuperAdminUser> {
    AdminMockSecurityContextFactory() {}

    public SecurityContext createSecurityContext(SuperAdminUser withUser) {
      String username =
