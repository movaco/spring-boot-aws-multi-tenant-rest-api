...
import de.movaco.server.shared.TestUser.UserMockSecurityContextFactory;
...
@Inherited
@Documented
@WithSecurityContext(factory = UserMockSecurityContextFactory.class)
...
public @interface TestUser {
  ...
  String[] roles() default {Roles.USER};
  ...
  class UserMockSecurityContextFactory implements WithSecurityContextFactory<TestUser> {

    UserMockSecurityContextFactory() {}

    public SecurityContext createSecurityContext(TestUser withUser) {
      String username =
      ...
      if (username == null) {
        ...
        org.springframework.security.core.userdetails.User principal =
            new org.springframework.security.core.userdetails.User(
                username, withUser.password(), true, true, true, true, grantedAuthorities);
